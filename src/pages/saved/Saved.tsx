...
import styles from "~/pages/saved/Saved.module.scss";
...
export default function Saved() {
    ...
    return (<>
        ...
        <div className={`container-xxl flex-grow-1 container-p-y ${styles.container}`}>
            <h2 className="fw-bold">Các thẻ đã lưu</h2>
            ...
            <div className={`${styles.learn_btn}`}>
                {LIST_LEARN_BTN.map((item) => (
                    <div key={item.name} className={` col-md-3 col-lg-3 col-6 col-sm-6 my-1 `}>
                        <div onClick={() => {item.link ? navigate(`${item.link}/${userData?.username}`) : null}} className={`card mx-2 ${styles.box_padding} hoverable cursor-pointer ${item.active ? "border-active" : ""}`}>
                        ...
                        <div className="content row">
                            ...
                            <div className="col-6">
                                ...
                                <div className={styles.next_process}>
                                    <div onClick={() => navigate(`/exam/${userData?.username}`)} className={`card hstack mx-1 my-3 row hoverable cursor-pointer`}>
                                        <div className={`col-2 `}>
                                    ...
                                    <div onClick={() => navigate(`/learn/${userData?.username}`)} className={`card hstack mx-1 my-3 row hoverable cursor-pointer`}>
                                        <div className={`col-2 `}>
            ...
            <div className={styles.author}>
                <Link to={`/account/${userData?.username}`}>
                    <div className="d-flex">
                        ...
                        <div className="">
                            <span className={`${styles.info} fw-semibold d-block`}>{userData?.username}</span>
            ...
            <div className={styles.btn}>
                <Tooltip title="Chỉnh sửa" placement="top" arrow>
                    <span className='bx bxs-pencil' onClick={() => navigate(`/create-credit/${userData?.username}`)}></span>
                </Tooltip>
            ...
            <div className={styles.detail}>
                ...
                <ListCard flashcards = {listFlashcard} isLearned={true}/>
            </div>
